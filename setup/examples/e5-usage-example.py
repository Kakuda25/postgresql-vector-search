...
input_texts = [
    'query: ワイヤレスイヤホン',
    'query: コーヒー豆',
    "passage: ワイヤレスイヤホン ANC ノイズキャンセリング対応。最大30時間再生。",
    "passage: スマートウォッチ Pro 心拍・睡眠計測、GPS内蔵。",
    "passage: 有機コーヒー豆 200g 中深煎り。エチオピア産シングルオリジン。"
]
...
# 商品データ
products = [
    "ワイヤレスイヤホン ANC ノイズキャンセリング対応。最大30時間再生。",
    "スマートウォッチ Pro 心拍・睡眠計測、GPS内蔵。",
    "有機コーヒー豆 200g 中深煎り。エチオピア産シングルオリジン。",
    "ランニングシューズ 軽量メッシュ。クッション性に優れた日常走行向け。",
    "保湿クリーム セラミド配合。乾燥肌向けの低刺激処方。"
]
